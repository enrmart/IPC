...
import com.mycompany.practica2.ControladorMovimientos;
...
public class VistaMovimientos extends javax.swing.JFrame {
    ...
    private ControladorMovimientos controladorMov;
    private ModeloCajero modelo;
    
    /**
     * Constructor de la Clase CajeroVista que inicializa el modelo del cajero
     */
    public VistaMovimientos(ModeloCajero modelo) {
        initComponents();       
        this.modelo = modelo;
        controladorMov = new ControladorMovimientos(this, modelo);
        controladorMov.Inicio();
    }
    ...
    /**
    * Boton  que cambiar de estado sel cajero a "Cajero Normal"
    ...
    */
    private void P1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P1ActionPerformed
       if(modelo.getEstadoPin()!= false){
           MainCajero.getStateMachine().UsoNormalCajero();
       }
    ...
    */
    private void P6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P6ActionPerformed
        if(modelo.getEstadoPin()!= false){
            controladorMov.inicializarCajero();
        }    
    ...
    private void CancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelarActionPerformed
        if(controladorMov.getTipoOpcion() == 1){
            controladorMov.inicializarNumero();
            controladorMov.inicializarContadoPin();
            controladorMov.imprimirPin();
           
        }else{
            controladorMov.cambiarTipoOpcion(0);
            controladorMov.nombreOpciones();
            imprimeTransacciones(null);
        }   
    }//GEN-LAST:event_CancelarActionPerformed

    /**
     * Boton  que cambiar de estado del cajero a "Transferencias"
     * @param evt variable que reacciona ante un evento del boton Consultar Transacciones
     */
    private void P2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P2ActionPerformed
        if(modelo.getEstadoPin()!= false){
            MainCajero.getStateMachine().transferencias();
        }
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if(controladorMov.getTipoOpcion() == 1){
            controladorMov.comprobarPin(controladorMov.getNumero());
        }       
    ...
    private void B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B1ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 1);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B2ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 2);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B3ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 3);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B4ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 4);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B5ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 5);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B6ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 6);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B7ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 7);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B8ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 8);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B9ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 9);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    private void B0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B0ActionPerformed
        if(controladorMov.getTipoOpcion() == 1  && controladorMov.getContadorPin() < 4){
            controladorMov.cambiarNumero(controladorMov.getNumero()*10 + 0);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()+1);
            controladorMov.imprimirPin();
        }
    ...
    /**
     * Boton que cambiar de estado del cajero a "Cambiar Pin"
     * @param evt variable que reacciona ante un evento del botón Consultar Saldo
     */
    private void P5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P5ActionPerformed
        if(modelo.getEstadoPin()!= false){
            MainCajero.getStateMachine().cambiarPinCajero();
        }
    ...
    private void BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorrarActionPerformed
        if(controladorMov.getTipoOpcion() == 1 && modelo.getEstadoPin() == false){
            controladorMov.cambiarNumero(controladorMov.getNumero()/10);
            controladorMov.cambiarContadorPin(controladorMov.getContadorPin()-1);
            controladorMov.imprimirPin();
        }
    ...
    public void imprimeTransacciones(String []trans){
        if(controladorMov.getTipoOpcion() == 3){
    ...
    public void imprimeOpciones(){
        P1.setText("Cajero");
        P2.setText("Transferencia");
        P5.setText("Cambiar PIN");
        P6.setText("Salir");
        ExtractorDinero.setText("Extractor Dinero");
        CanatidadDinero.setText("Cantidad Dinero");
    ...
    /**
     * Metodo que establece el texto de inicio del cajero
     */
