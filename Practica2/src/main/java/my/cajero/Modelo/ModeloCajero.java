...
public class ModeloCajero {
    ...
    private void datosTarjeta(){
        ...
        trans.add("- 200 > 12/02/2022");
        trans.add("- 100 > 10/01/2022");
    ...
    public void añadirTransaccion(int importe){
        ...
        trans.add(0, "- " + importe + " > " + formatter.format(dia));
    ...
    /*
    *Metodo que cambia el numero PIN de la tarjeta
    *@param numero que sera el nuevo PIN
    */
    public void setPIN(int numero){
        this.pin = numero;
        tarjeta.put(identificadorTajeta, pin);
    }
    /**
     * 
     * @param x numero que indica las pulsaciones  
     */
    public void setPulsaciones(int x){
            this.pulsaciones = x;
    }
    /**
     * 
     * @return  las pulsaciones 
     */
    public int getPulsaciones(){
        return pulsaciones;
    }
    
    public void setNumPulsa(int bot){
        this.numPulsa=bot;
    }
    
    public int getNumPulsa(){
        return numPulsa;
    }
