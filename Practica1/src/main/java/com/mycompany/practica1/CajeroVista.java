...
public class CajeroVista extends javax.swing.JFrame {
    ...
    private CajeroControlador controlador;
    ...
    public CajeroVista() {
        ...
        controlador = new CajeroControlador(this, modelo);
        controlador.Inicio();
    }
    ...
    */
    private void P1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P1ActionPerformed
        if(modelo.getEstadoPin()!= false){
            controlador.cambiarTipoOpcion(2);
            imprimeTransacciones(null);
            controlador.nombreOpciones(); 
    ...
    */
    ...
    private void CancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelarActionPerformed
        if(controlador.getTipoOpcion() == 1){
            controlador.inicializarNumero();
            controlador.inicializarContadoPin();
            controlador.imprimirPin();
           
        }else{
            controlador.cambiarTipoOpcion(0);
            controlador.nombreOpciones();
            imprimeTransacciones(null);
        }   
    ...
    private void P2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P2ActionPerformed
        if(modelo.getEstadoPin()!= false){
            controlador.cambiarTipoOpcion(3);
            controlador.inicializarNumero();
            controlador.muestraTransacciones();
        }
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if(controlador.getTipoOpcion() == 1){
            controlador.comprobarPin(controlador.getNumero());
        }
        if(controlador.getTipoOpcion() == 2){
            controlador.retirarDinero(controlador.getNumero());
        }
    ...
    private void TarjetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TarjetaActionPerformed
        if(modelo.getEstadoPin() == false){
            controlador.cambiarTipoOpcion(1);
    ...
    private void B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B1ActionPerformed
        if(controlador.getTipoOpcion() == 1 || controlador.getTipoOpcion() == 2){
            controlador.cambiarNumero(controlador.getNumero()*10 + 1);
        }
        if(controlador.getTipoOpcion() == 1  && controlador.getContadorPin() < 4){
            controlador.cambiarContadorPin(controlador.getContadorPin()+1);;
            controlador.imprimirPin();
        }
        if(controlador.getTipoOpcion() == 2){
            imprimeDineroARetirar(controlador.getNumero());
        }
    ...
    private void B0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B0ActionPerformed
        if(controlador.getTipoOpcion() == 1 || controlador.getTipoOpcion() == 2){
            controlador.cambiarNumero(controlador.getNumero()*10 + 0);
        }
        if(controlador.getTipoOpcion() == 1  && controlador.getContadorPin() < 4){
            controlador.cambiarContadorPin(controlador.getContadorPin()+1);
            controlador.imprimirPin();
    ...
    private void P5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P5ActionPerformed
        if(modelo.getEstadoPin()!= false){
            controlador.cambiarTipoOpcion(4);
            imprimeTransacciones(null);
            ExtractorDinero.setText("Extractor Dinero");
            CanatidadDinero.setText("Cantidad Dinero"); 
            controlador.mostrarSaldoDisponible();
        }
    ...
    public void imprimeTransacciones(String []trans){
        if(controlador.getTipoOpcion() == 3){
